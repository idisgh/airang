      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr class="border-b border-neutral-100 dark:border-neutral-800 bg-primary-50/50 dark:bg-primary-950/20">
            ...
            <td class="p-4 text-center text-amber-500 font-medium"><LIcon name="lucide:star" fill="currentColor" class="w-3 h-3 text-amber-500 inline" /> {{ tool.rating }}</td>
          </tr>
          <tr v-for="alt in (alternatives || [])" :key="alt.id" class="border-b border-neutral-100 dark:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
            ...
            <td class="p-4 text-center text-amber-500 font-medium"><LIcon name="lucide:star" fill="currentColor" class="w-3 h-3 text-amber-500 inline" /> {{ alt.rating }}</td>
          </tr>
        </tbody>
      </table>
    </div>
