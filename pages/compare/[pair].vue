      ...
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-neutral-100 dark:divide-neutral-800">
          ...
          <tr>
            ...
            <td class="p-4 text-neutral-700 dark:text-neutral-300"><ul class="space-y-1"><li v-for="f in toolA.features" :key="f" class="text-xs"><LIcon name="lucide:check" class="w-3 h-3 text-primary-500 inline shrink-0" /> {{ f }}</li></ul></td>
            <td class="p-4 text-neutral-700 dark:text-neutral-300"><ul class="space-y-1"><li v-for="f in toolB.features" :key="f" class="text-xs"><LIcon name="lucide:check" class="w-3 h-3 text-primary-500 inline shrink-0" /> {{ f }}</li></ul></td>
          </tr>
        </tbody>
      </table>
    </div>
